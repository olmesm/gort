...
def create_app(settings: Settings | None = None) -> FastAPI:
	from goto import api, auth, graphql, public, ui
	from goto.db import create_engine_and_migrate
	from goto.middleware import SecurityMiddleware
	from goto.models import Domain, User
	...
	def health():
		try:
			...
			return JSONResponse({"status": "fail", "version": __version__}, status_code=503)
