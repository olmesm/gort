...
1.68.0 from npm. Goto bundles it under the MIT license in
...
2. Rename the local file and update its references in `goto/app.py` and
   `goto/templates/rest-docs.html`.
