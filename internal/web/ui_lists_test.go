...
func TestListPagesPaginationAndFilters(t *testing.T) {
	...
	for _, tc := range []struct{ path, want string }{
		...
		{"/admin/webhooks?search=https%3A%2F%2Fa-item-099.test", "Page 1 of 1 · 1 item"},
		{"/admin/users?role=admin", "Page 1 of 1 · 1 item"},
		{"/admin/users?role=user&page=2", "Page 2 of 4 · 100 items"},
		{"/admin/domains?status=default", "Page 1 of 1 · 1 item"},
		...
		{"/admin/api-keys?status=expired", "Page 1 of 1 · 1 item"},
